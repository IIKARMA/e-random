...
const RandomGeneratorNumber = () => {
  ...
  const [hiddenResultaBox, setHiddenResultaBox] = useBoolean(false);
  ...
  useEffect(() => {
    const handleWindowResize = () => {
      setWindoWidth(window.screen.availWidth);
    };
  ...
  useEffect(() => {
    if (windowWidth < 380) setHiddenResultaBox.on();
    else setHiddenResultaBox.off();
  }, [windowWidth, setHiddenResultaBox]);
